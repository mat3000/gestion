...
<div class="detail more-task" data-task-id="<?= $res->id ?>" >
	...
	<div class="truc" ><label><span class="icon icon-folder"></span></label><div class="input-text" name="description" contenteditable placeholder="description"><?= $res->description; ?></div></div>
	...
	<div class="truc" ><label><span class="icon icon-doc-text-inv"></span></label><div class="input-text" contenteditable placeholder="sub-task"></div></div>
